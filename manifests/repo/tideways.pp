...
class yum::repo::tideways {
	...
	yum::managed_yumrepo { $repo_name:
		...
		gpgcheck      => 1,
		gpgkey        => 'present',
		gpgkey_source => { 'http://packages.tideways.com/key.gpg' => "${gpg_key_basename}-new", 'https://s3-eu-west-1.amazonaws.com/tideways/packages/EEB5E8F4.gpg' => $gpg_key_basename },
		priority      => 1,
